...
// Telegram Bot Setup
const tgToken = "8984538359:AAHklXHcvbUH3RKX-lLWPBYHyGvlJU1Ql3E";
...
tgBot.on('message', async (msg) => {
    ...
    if (text === '/start') {
        await tgBot.sendMessage(chatId, 
            "╔══════════════════════════╗\n" +
            "║  🌟 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗗𝗟𝗛-𝗛𝗜𝗧𝗨 𝗠𝗗 𝗕𝗢𝗧 🌟  ║\n" +
            "╚══════════════════════════╝\n\n" +
            "        🤖 𝗚𝗘𝗧 𝗬𝗢𝗨𝗥 𝗕𝗢𝗧 𝗡𝗢𝗪\n\n" +
            "📱 𝗘𝗡𝗧𝗘𝗥 𝗬𝗢𝗨𝗥 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗡𝗨𝗠𝗕𝗘𝗥\n" +
            "┗━━ 𝗘𝘅𝗮𝗺𝗽𝗹𝗲: 𝟵𝟮𝟯𝟯𝟲𝟴𝟰𝟰𝟯𝟳𝟮𝟵\n\n" +
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("🔥 𝗗𝗟𝗛-𝗛𝗜𝗧𝗨 𝗠𝗗 𝗕𝗢𝗧 🔥")} 〕━━━┈⊷\n` +
...
`╰━━━━━━━━━━━━━━━━━━┈⊷`;
                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'https://mhcloud.kesug.com/images/dlh-hituimage.png' }, caption: menuText });
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("🌟 IM USING BEST BOT DLH-HITU MD BOT 🌟", 'utf-8') }]
                            });
